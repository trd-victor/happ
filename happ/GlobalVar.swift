...
struct globalvar {
    ...
    static var API_URL: NSURL = NSURL(string: "http://happ.biz/wp-admin/admin-ajax.php")!
    ...
    //DEV API
//     happ.timeriver.asia/wp-admin/admin-ajax.php
    
    
//    dev API
//     dev.happ.timeriverdesign.com/wp-admin/admin-ajax.php
    //PRD API
